          ...
          return (
            <label
              ...
              className={
                ...
                (active
                  ? "bg-legend-gold/15 border-legend-gold/60 ring-1 ring-legend-gold/40"
                  : "bg-warm-cream/5 border-warm-cream/10 hover:bg-warm-cream/[0.07]")
              }
            >
              <input
                type="radio"
                ...
                className="mt-0.5 h-4 w-4 text-legend-gold focus:ring-legend-gold/60"
              />
              <span className="text-sm text-warm-cream/85">
                <span className="font-medium text-warm-cream">
                  {o.emoji} {o.title}
                </span>
                <span className="block text-xs text-warm-cream/55 mt-0.5">{o.hint}</span>
              </span>
            </label>
          );
        })}
  ...
  return (
    <form action={action} className="space-y-6 max-w-3xl">
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
        ...
        <div>
          ...
          <select id="category_id" name="category_id" required defaultValue={stop?.category_id ?? ""}
            className={inputClass + " [&>option]:bg-ink-black [&>option]:text-warm-cream"}>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        ...
        <p className="sm:col-span-2 -mt-3 text-xs text-warm-cream/45">
